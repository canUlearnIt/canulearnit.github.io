	...
	for (key in inputFields) {
		...
		if (!(isValid)) {
			...
			else{myError.innerHTML = "Input does not match pattern: "+ myPlaceholder;
				this.focus();
			}
			//myField.focus();
...
// age check
		...
		if (isNaN(numAge)) {
			myError.innerHTML=("You must type a number for your age!");
			thisAge.focus();
		}
		if (numAge > 17) {
			myError.innerHTML=("");
...
var imageArray = ["prog.jpg", "data.jpg", "eng.png", "math.jpg", "web.jpg"];
var imageIndex=0;
